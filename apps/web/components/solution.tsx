...
export const Solution = () => {
    return (
        <section className="py-20 md:py-32 bg-background px-4 relative">
            <BorderBeam />
            <div className="max-w-6xl mx-auto text-center mb-16 md:mb-20">
                ...
                <p className="text-lg md:text-xl text-gray-400">We don't replace Instagram. We just make it lethal.</p>
            </div>
